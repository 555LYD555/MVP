<template>
  <div style="display:block;justify-content:center;height:100%;width:100%;background:#f8fbff;">
    <div style="display:flex;font-size:22px;padding:5vh 0 15px 0;font-weight:600;width:100%;">
      ...
      <span style="font-family:'MVP2Font';">Welcome to MVP</span>
    </div>
    <!-- 卡片轮播区域 -->
    <div>
...
export default ({
  ...
  data () {
    return {
      ...
      //经过处理的子系统数据
      dealSysData: [
        [{sysName:"高德地图",sysUrl:"/4",sysDesc:"高德地图简介"},{sysName:"天地图",sysUrl:"/3",sysDesc:"天地图简介"},{sysName:"特效按钮",sysUrl:"/5",sysDesc:"各种CSS特效边框和动画的按钮"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"}],
        [{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"}],
        [{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"},{sysName:"天地图",sysUrl:"/4",sysDesc:"天地图简介"}],
      ],
...
.themeFour{
  background:linear-gradient(90deg,#7bd8a8, #23d06e);
}
.sysDescText {
  margin-top: 10px;
  font-size: 13px;
